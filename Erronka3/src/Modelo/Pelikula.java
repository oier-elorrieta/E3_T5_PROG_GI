...
public class Pelikula {
	...
	public String toString() {
		return "Pelikula izena " + izena + ", identifikatzailea " + id_peli + ", iraupena " + iraupena
				+ ", generoa " + generoa + ", prezioa " + prezioa + " ";
	}
	@Override
	public int hashCode() {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(generoa, other.generoa) && id_peli == other.id_peli
				&& iraupena == other.iraupena && Objects.equals(izena, other.izena)
