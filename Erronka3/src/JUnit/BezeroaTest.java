...
public class BezeroaTest {
    ...
    public void testEquals() {
        ...
        Bezeroa bezeroa3 = new Bezeroa(1, "Izena", "Abizena", "12345678A", "Gizona", "password", "erabiltzailea1");
        assertFalse(bezeroa1.equals(bezeroa2)); 
        assertTrue(bezeroa1.equals(bezeroa3)); 
    }
    ...
    public void testToString() {
        Bezeroa bezeroa = new Bezeroa(1, "Izena", "Abizena", "12345678A", "Gizona", "password", "erabiltzailea1");
        assertEquals("Bezeroa izena Izena, abizena Abizena, nan 12345678A, sexua Gizona, pasahitza password, Erabiltzailea erabiltzailea1, bezero_id 1", bezeroa.toString());
    }
}
