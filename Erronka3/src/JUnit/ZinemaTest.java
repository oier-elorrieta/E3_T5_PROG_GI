...
public class ZinemaTest {
	  @Test
	    public void testGetSaioalistArray() {
	        ...
	        Zinema zinema = new Zinema(1, "Zinemaldia", "Bilbao", saioaList, null);
	    ...
	    public void testGetAretolistarray() {
	        ...
	        Zinema zinema = new Zinema(1, "Zinemaldia", "Bilbao", null, aretoList);
    ...
    public void testNotEquals() {
        Zinema zinema1 = new Zinema(1, "Zinemaldia", "Bilbao", null, null);
        Zinema zinema2 = new Zinema(2, "Zinefest", "Donostia", null, null);
